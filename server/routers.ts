...
export const appRouter = router({
  ...
  alimentacao: router({
    ...
    excluirFuncionario: alimentacaoAccessProcedure.input(z.object({ id:z.number().int().positive() })).mutation(({input})=>alimentacao.excluirFuncionario(input.id)),
    ...
    excluirFornecedor: alimentacaoAccessProcedure.input(z.object({ id:z.number().int().positive() })).mutation(({input})=>alimentacao.excluirFornecedor(input.id)),
