...
const REQUIRED_TABLES = [
  ...
  "licitacao_status",
  "licitacao_plataformas",
  "licitacao_vendedores",
  "licitacoes",
  "licitacao_atas",
  "licitacao_adesoes",
  "licitacao_adesao_pedidos_crti",
  "licitacao_pedidos_crti",
...
const REQUIRED_COLUMNS = {
  ...
  licitacao_status: ["id", "nome", "criadoEm", "atualizadoEm"],
  licitacao_plataformas: ["id", "nome", "link", "criadoEm", "atualizadoEm"],
  licitacao_vendedores: ["id", "nome", "criadoEm", "atualizadoEm"],
  licitacoes: [
    "id",
    "data",
    "orgao",
  ...
  licitacao_adesoes: [
    ...
    "dataPedidoCrti",
    "statusPedidoCrti",
    "quantidadePedidoCrti",
    "valorTotalPedidoCrti",
    "observacoes",
    "criadoPor",
    "criadoEm",
    "atualizadoEm",
